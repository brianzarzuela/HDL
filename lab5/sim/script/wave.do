...
add wave -noupdate /add_sub_state_machine_tb/uut/switch
add wave -noupdate /add_sub_state_machine_tb/uut/btn
add wave -noupdate /add_sub_state_machine_tb/uut/a
add wave -noupdate /add_sub_state_machine_tb/uut/b
add wave -noupdate -radix States /add_sub_state_machine_tb/uut/hundreds
add wave -noupdate -radix States /add_sub_state_machine_tb/uut/tens
add wave -noupdate -radix States /add_sub_state_machine_tb/uut/ones
